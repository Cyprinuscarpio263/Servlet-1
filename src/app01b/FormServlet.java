...
public class FormServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		writer.println("<body><h1>"+TITLE+"</h1><form method='post'>");
		writer.println("<table><tr><td>Name:</td><td><input name='name'/></td></tr>");
		writer.println("<tr><td>Address:</td><td>");
		writer.println("<textarea name='address' cols='40' rows='5'></textarea></td></tr>");
		writer.println("<tr><td>Country:</td><td><select name='country'>");
		writer.println("<option>United States</option><option>Canada</option></select></td>");
		writer.println("</tr><tr><td>Delivery Method</td>");
		...
		writer.println("</tr><tr><td>Shipping Instructions:</td>");
		writer.println("<td><textarea name='instruction' cols='40' rows='5'></textarea></td>");
		writer.println("</tr><tr><td>&nbsp;</td>");
		writer.println("<td><textarea name='instruction' cols='40' rows='5'></textarea></td>");
		writer.println("</tr><tr><td>Please send me the latest product catalog:</td>");
		writer.println("<td><input type='checkbox' name='catalogRequest'/></td>");
		writer.println("</tr><tr><td>&nbsp;</td><td><input type='reset'/><input type='submit'/></td>");
